...
test('.syntax(language)', function (t) {
  t.throws(
    function () {
      refractor.syntax();
    },
  ...
  t.notOk(
    refractor.syntax('notalanguage'),
    'should return undefined when language not registered'
  );
  t.ok(
    refractor.syntax('markdown'),
    'should return syntax if language is registered'
  );
  t.end();
});
